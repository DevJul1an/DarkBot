package org.darkstorm.darkbot.minecraftbot.protocol.v47x;
...
import org.darkstorm.darkbot.minecraftbot.protocol.v47x.handshake.PacketHC00_Handshake;
import org.darkstorm.darkbot.minecraftbot.protocol.v47x.login.client.PacketLC00_LoginStart;
import org.darkstorm.darkbot.minecraftbot.protocol.v47x.login.client.PacketLC01_EncryptionResponse;
import org.darkstorm.darkbot.minecraftbot.protocol.v47x.login.server.PacketLS00_Disconnect;
import org.darkstorm.darkbot.minecraftbot.protocol.v47x.login.server.PacketLS01_EncryptionRequest;
import org.darkstorm.darkbot.minecraftbot.protocol.v47x.login.server.PacketLS02_LoginSuccess;
import org.darkstorm.darkbot.minecraftbot.protocol.v47x.play.client.*;
import org.darkstorm.darkbot.minecraftbot.protocol.v47x.play.server.*;
...
public final class Protocol47X extends AbstractProtocolX implements EventListener {
	...
	public final class LengthPacket extends AbstractPacketX implements ReadablePacket {
		...
		protected LengthPacket(int id, int length) {
			super(id, Protocol47X.this.getState(), Direction.DOWNSTREAM);
	...
	public Protocol47X(MinecraftBot bot) {
		super(VERSION);
		this.bot = bot;
	...
	public static final class Provider extends ProtocolProvider<Protocol47X> {
		@Override
		public Protocol47X getProtocolInstance(MinecraftBot bot) {
			return new Protocol47X(bot);
		}
