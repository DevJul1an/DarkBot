package org.darkstorm.darkbot.minecraftbot.protocol.v1_8;
...
import org.darkstorm.darkbot.minecraftbot.event.io.PacketProcessEvent;
import org.darkstorm.darkbot.minecraftbot.event.io.PacketReceivedEvent;
import org.darkstorm.darkbot.minecraftbot.event.io.PacketSentEvent;
...
import org.darkstorm.darkbot.minecraftbot.protocol.v1_8.handshake.PacketHC00_Handshake;
import org.darkstorm.darkbot.minecraftbot.protocol.v1_8.login.client.PacketLC00_LoginStart;
import org.darkstorm.darkbot.minecraftbot.protocol.v1_8.login.client.PacketLC01_EncryptionResponse;
import org.darkstorm.darkbot.minecraftbot.protocol.v1_8.login.server.PacketLS00_Disconnect;
import org.darkstorm.darkbot.minecraftbot.protocol.v1_8.login.server.PacketLS01_EncryptionRequest;
import org.darkstorm.darkbot.minecraftbot.protocol.v1_8.login.server.PacketLS02_LoginSuccess;
import org.darkstorm.darkbot.minecraftbot.protocol.v1_8.play.client.*;
import org.darkstorm.darkbot.minecraftbot.protocol.v1_8.play.server.*;
...
public final class Protocol1_8X extends AbstractProtocolX implements EventListener {
	...
	public final class LengthPacket extends AbstractPacketX implements ReadablePacket {
		...
		protected LengthPacket(int id, int length) {
			super(id, Protocol1_8X.this.getState(), Direction.DOWNSTREAM);
	...
	public static final String VERSION_NAME = "1.8.X";
	...
	public Protocol1_8X(MinecraftBot bot) {
		super(VERSION);
		this.bot = bot;
	...
	public void onPacketProcess(PacketProcessEvent event) {
		...
		case PLAY:
			...
			case 0x01: {
				...
				connectionHandler.sendPacket(new PacketC15_ClientSettings("en_US", PacketC15_ClientSettings.ViewDistance.FAR, PacketC15_ClientSettings.ChatMode.ENABLED, Difficulty.NORMAL, true, true));
				try {
			...
			case 0x09: {
				...
				eventBus.fire(new ChangeHeldItemEvent(heldItemPacket.getSlot()));
				break;
			}
			case 0x0A: {
			...
			case 0x0B: {
				...
				if(animationPacket.getAnimation() == PacketS0B_Animation.Animation.EAT_FOOD)
			...
			case 0x26: {
				...
				for(PacketS21_ChunkData.ChunkData chunk : chunkPacket.getChunks())
	...
	private void processChunk(PacketS21_ChunkData.ChunkData chunk, boolean addSkylight, boolean addBiomes) {
		if(chunk == null)
			return;
	...
	public static final class Provider extends ProtocolProvider<Protocol1_8X> {
		@Override
		public Protocol1_8X getProtocolInstance(MinecraftBot bot) {
			return new Protocol1_8X(bot);
		}
